...
namespace PCSC
{
    ...
    public enum SCardError
    {
        ...
        /// <summary>The apdu format wrong.(CUSTOM_ERROR)</summary>
        [Description("CUSTOM_ERROR:The apdu format wrong.")]
        ApduFormatWrong = unchecked((int)0x80100880),

        /// <summary>No Redaer Selected.(CUSTOM_ERROR)</summary>
        [Description("CUSTOM_ERROR:No Redaer Selected.")]
        NoReaderSelected = unchecked((int)0x80100881),

        /// <summary>No Redaer Connected.(CUSTOM_ERROR)</summary>
        [Description("CUSTOM_ERROR:No Redaer Connected.")]
        NoReaderConnected = unchecked((int)0x80100882),

        /// <summary>JCOP Connect Failed.(CUSTOM_ERROR)</summary>
        [Description("CUSTOM_ERROR:JCOP Connect Failed.")]
        JCOPConnectFailed = unchecked((int)0x80100883),

        /// <summary>JCOP Receive Failed.(CUSTOM_ERROR)</summary>
        [Description("CUSTOM_ERROR:JCOP Receive Failed.")]
        JCOPReceiveFailed = unchecked((int)0x80100884),

        /// <summary>JCOP Response Format Error.(CUSTOM_ERROR)</summary>
        [Description("CUSTOM_ERROR:JCOP Response Format Error.")]
        JCOPResponseFormatError = unchecked((int)0x80100884)
    }
}
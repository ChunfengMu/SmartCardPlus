...
namespace PCSC
{
    ...
    public class SCardContext : ISCardContext
    {
        ...
        public void Establish(SCardScope scope) {
            ...
            switch (rc) {
                ...
                case SCardError.InvalidValue:
                    throw new InvalidScopeTypeException(rc, "PCSC: Invalid scope type passed");
                default:
                    throw new PCSCException(rc, "PCSC: "+SCardHelper.StringifyError(rc));
            }
        }
        ...
        public void Release() {
            if (!_hasContext) {
                throw new InvalidContextException(SCardError.UnknownError, "PCSC: "+"Context was not established");
            }
            ...
            switch (rc) {
                ...
                case SCardError.InvalidHandle:
                    throw new InvalidContextException(rc, "PCSC: " + "Invalid Context handle");
                default:
                    throw new PCSCException(rc, "PCSC" + SCardHelper.StringifyError(rc));
            }
        }
        ...
        public string[] GetReaders(string[] groups) {
            if (_contextPtr.Equals(IntPtr.Zero)) {
                throw new InvalidContextException(SCardError.InvalidHandle,"PCSC: The supplied handle was invalid.");
            }
            ...
            switch (rc) {
                case SCardError.Success:
                    return readers;
                case SCardError.InvalidHandle:
                    throw new InvalidContextException(rc, "PCSC: "+"Invalid Scope Handle");
                default:
                    return null;
        ...
        public string[] GetReaderGroups() {
            ...
            switch (sc) {
                case SCardError.Success:
                    return groups;
                case SCardError.InvalidHandle:
                    throw new InvalidContextException(sc, "PCSC: "+"Invalid Scope Handle");
                default:
                    throw new PCSCException(sc, "PCSC: " + SCardHelper.StringifyError(sc));
            }
        }
        ...
        public SCardError Cancel() {
            if (_contextPtr.Equals(IntPtr.Zero)) {
                throw new InvalidContextException(SCardError.UnknownError, "PCSC: "+"Invalid connection context.");
            }

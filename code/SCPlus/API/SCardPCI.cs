        ...
        public static IntPtr GetPci(SCardProtocol protocol) {
            switch (protocol) {
                ...
                default:
                    ...
                    throw new InvalidProtocolException(SCardError.InvalidValue, "PCSC: 0x" + ((int)SCardError.InvalidValue).ToString("X8") + ", One or more of the supplied parameters values could not be properly interpreted.");

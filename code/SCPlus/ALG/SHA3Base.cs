...
namespace ALG
{
    public abstract class SHA3Base :System.Security.Cryptography.HashAlgorithm
    {
        #region Statics
        public static string DefaultHashName = "SHA512";

        protected static Dictionary<string, Func<SHA3Base>> HashNameMap;

        static SHA3Base()
        {
            HashNameMap = new Dictionary<string, Func<SHA3Base>>
            {
        ...
        public static new SHA3Base Create()
        {
            return Create(DefaultHashName);
        }

        public static new SHA3Base Create(string hashName)
        {
            Func<SHA3Base> ctor;
        ...
        protected SHA3Base(int hashBitLength)
        {
